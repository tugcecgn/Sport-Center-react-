...
var addclasses = function addclasses(node, classes) {
  return (
    classes &&
    classes.forEach(function (classNameName) {
...
var applyclasses = function applyclasses(el, top) {
  ...
  var hide = function hide() {
    ...
    removeclasses(node, options.animatedclassNameNames);
  ...
  var show = function show() {
    ...
    addclasses(node, options.animatedclassNameNames);
...
var prepare = function prepare($elements, options) {
  $elements.forEach(function (el, i) {
    ...
    var customclassNameNames =
      options.useclassNameNames && el.node.getAttribute("data-aos");

    var animatedclassNameNames = [options.animatedclassNameName]
      .concat(customclassNameNames ? customclassNameNames.split(" ") : [])
      .filter(function (classNameName) {
