(function (global, factory) {
  ...
  function resetSlideMove(slide) {
    ...
    var windowWidth =
      ...
      document.documentElement.clientWidth ||
      document.body.clientWidth;
    var media = hasclassName(slide, "gslide-media")
      ? slide
  ...
  function touchNavigation(instance) {
    ...
    var touchInstance = new TouchEvents(sliderWrapper, {
      touchStart: function touchStart(e) {
        ...
        if (
          hasclassName(e.targetTouches[0].target, "ginner-container") ||
        ...
        if (
          ...
          !hasclassName(e.targetTouches[0].target.parentNode, "gslide-inline")
        ) {
          process = false;
        }
    ...
    _createclassName(GlightboxInit, [
      ...
      },
      {
        ...
        value: function showSlide() {
          ...
          this.slideDescriptionContained =
            ...
            hasclassName(this.slideDescription.parentNode, "gslide-media");
      ...
      },
      {
        ...
        value: function slideAnimateIn(slide, first) {
          ...
          removeclassName(slide, this.effectsclasses);
      ...
      },
      {
        ...
        value: function slideAnimateOut() {
          ...
          removeclassName(prevSlide, this.effectsclasses);
            ...
            this.events["outClose"] = addEvent("click", {
              ...
              withCallback: function withCallback(e, target) {
                if (
                  ...
                  !hasclassName(document.body, "glightbox-mobile") &&
                  !closest(e.target, ".ginner-container")
                ) {
                  if (
                    !closest(e.target, ".gbtn") &&
                    !hasclassName(e.target, "gnext") &&
                    !hasclassName(e.target, "gprev")
                  ) {
                    _this7.close();
                  }
                }
      ...
      },
      {
        ...
        value: function resize() {
          ...
          if (
            description &&
            (hasclassName(description, "description-bottom") ||
              hasclassName(description, "description-top")) &&
            !hasclassName(description, "gabsolute")
          ) {
